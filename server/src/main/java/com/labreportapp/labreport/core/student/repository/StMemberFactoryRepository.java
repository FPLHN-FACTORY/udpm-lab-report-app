 ...
 */
public interface StMemberFactoryRepository extends MemberFactoryRepository {
    ...
    @Query(value = """
            ...
            ORDER BY a.created_date DESC
            """, nativeQuery = true)
    Page<StMemberFactoryResponse> getAllRoleProject(Pageable pageable, @Param("req") StFindMemberFactoryRequest req);
