...
public class AdExportExcelClass {
    ...
    public ByteArrayOutputStream export(HttpServletResponse response, List<AdExportExcelClassCustom> listClass, List<SimpleResponse> listGiangVien) {
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            if (listClass != null) {
                for (AdExportExcelClassCustom classResponse : listClass) {
                    ...
                    Cell empHoatDongCell = empDataRow.createCell(6);
