...
public interface StAttendanceRepository extends AttendanceRepository {
    ...
    @Query(value = """                        
            ...
            m.meeting_period, m.type_meeting, m.teacher_id, a.status AS status, a.notes as notes
            FROM attendance a
            ...
            GROUP BY m.id,m.name, m.meeting_date, m.meeting_period, m.type_meeting, m.teacher_id, a.status,a.notes
