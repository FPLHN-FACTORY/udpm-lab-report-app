...
public class AdRoleFactoryServiceImpl implements AdRoleFactoryService {
    ...
    @Override
    public RoleFactory createRoleFactory(AdCreateRoleFactoryRequest obj) {
        RoleFactory roleFactory = formUtils.convertToObject(RoleFactory.class, obj);
        return adRoleFactoryRepository.save(roleFactory);
    }

    @Override
    public RoleFactory updateRoleFactory(AdUpdateRoleFactoryRequest obj) {
