...
const ModalShowHistoryLogLuong = ({ idSemester, visible, onCancel }) => {
  useEffect(() => {
    setDataHistory([]);
  }, [visible]);
  ...
  useEffect(() => {
    if (visible && idSemester != null && idSemester !== "") {
      loadDataHistory();
    }
...
export default ModalShowHistoryLogLuong;
